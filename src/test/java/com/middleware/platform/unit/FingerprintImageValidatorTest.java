...
class FingerprintImageValidatorTest {
    ...
    static ImageValidationSettings enforce() {
        ...
        return new ImageValidationSettings(true, Mode.ENFORCE, d.allowedFormats(),
                ...
                d.maxImageBytes(), d.requireGrayscale8Bit(), d.checkBlank(), d.minStdDev(), d.wsqMaxCompressionRatio());
    }

    static ImageInfo goodPng() { return new ImageInfo(ImageFormat.PNG, 90_000, 500, 500, 8, true, 500, null, 60.0, null); }
    static ImageInfo goodWsq() { return new ImageInfo(ImageFormat.WSQ, 30_000, 500, 500, 8, true, 500, 8.3, null, null); }
    ...
    void disabledSkips_andWarnModeNeverRejects() {
        ...
        ImageValidationSettings off = new ImageValidationSettings(false, Mode.ENFORCE, d.allowedFormats(),
                ...
                d.maxImageBytes(), true, true, d.minStdDev(), d.wsqMaxCompressionRatio());
    ...
    void eachRuleProducesAnActionableMessage() {
        ...
        assertThat(msg(new ImageInfo(ImageFormat.UNKNOWN, 5000, null, null, null, null, null, null, null, null), s))
        ...
        ImageValidationSettings pngOnly = new ImageValidationSettings(true, Mode.ENFORCE, Set.of(ImageFormat.PNG),
                200, 200, 2000, 2000, false, 490, 510, 2_097_152, true, true, 10, 15);
        assertThat(msg(goodWsq(), pngOnly)).contains("WSQ images are not accepted").contains("allowed: PNG");

        assertThat(msg(new ImageInfo(ImageFormat.PNG, 3_000_000, 500, 500, 8, true, null, null, 60.0, null), s))
                .contains("exceeds the maximum 2.0 MB");
        assertThat(msg(new ImageInfo(ImageFormat.PNG, 9000, 120, 140, 8, true, null, null, 60.0, null), s))
                .contains("120×140").contains("minimum 200×200");
        assertThat(msg(new ImageInfo(ImageFormat.PNG, 9000, 2500, 500, 8, true, null, null, 60.0, null), s))
                .contains("exceeds the maximum 2000×2000");
        assertThat(msg(new ImageInfo(ImageFormat.PNG, 9000, 500, 500, 8, false, null, null, 60.0, null), s))
                .contains("8-bit greyscale").contains("colour");
        assertThat(msg(new ImageInfo(ImageFormat.PNG, 9000, 500, 500, 8, true, 300, null, 60.0, null), s))
                .contains("300 ppi").contains("490–510");
        assertThat(msg(new ImageInfo(ImageFormat.WSQ, 5000, 500, 500, 8, true, 500, 50.0, null, null), s))
                .contains("compression 50.0:1").contains("15:1");
        assertThat(msg(new ImageInfo(ImageFormat.PNG, 9000, 500, 500, 8, true, null, null, 1.2, null), s))
                .contains("blank or uniform");
        assertThat(msg(new ImageInfo(ImageFormat.PNG, 9000, 500, 500, 8, true, null, null, null, "PNG cannot be decoded"), s))
                .contains("cannot be decoded");
    }

    @Test
    void unknownPpiPassesUnlessRequired() {
        ImageInfo noPpi = new ImageInfo(ImageFormat.PNG, 9000, 500, 500, 8, true, null, null, 60.0, null);
    ...
    void settingsCrossFieldValidation() {
        ...
        ImageValidationSettings bad = new ImageValidationSettings(true, Mode.ENFORCE, Set.of(ImageFormat.PNG),
                900, 200, 500, 2000, false, 490, 510, 2_097_152, true, true, 10, 15);
