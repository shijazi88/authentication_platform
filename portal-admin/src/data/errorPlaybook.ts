...
export const ENTRIES: PlaybookEntry[] = [
  ...
  {
    code: 1003, http: 400, enumName: "IMAGE_QUALITY_REJECTED", category: "request", severity: "guide", escalateLevel: "no",
    keywords: "1003 image quality rejected nfiq low score blank partial smudged recapture imageQuality جودة الصورة منخفضة إعادة التقاط",
    name: { en: "Fingerprint image quality rejected", ar: "رُفضت جودة صورة البصمة" },
    meaning: { en: "Our platform measured the fingerprint before sending it anywhere and found it unusable: blank, partial, smudged, or an NFIQ 2 score below the minimum (default 40). The bank was not charged. The transaction shows the score and the exact reason under “Image check”.", ar: "قاست منصّتنا البصمة قبل إرسالها إلى أي جهة ووجدتها غير صالحة: فارغة أو جزئية أو ملطّخة أو بدرجة NFIQ 2 أقل من الحد الأدنى (الافتراضي 40). لم يُخصم من البنك. تعرض المعاملة الدرجة والسبب الدقيق تحت «فحص الصورة»." },
    action: { en: "Ask the operator to recapture: clean the sensor, finger flat and centred with firm, even pressure, the full pad on the glass. If one bank keeps scoring just under the minimum with real prints, review its scores in Reports → Fingerprint quality and consider a bank-specific minimum on the client page.", ar: "اطلب من المشغّل إعادة الالتقاط: تنظيف الماسح، الإصبع مسطّح وفي المنتصف بضغط ثابت ومتساوٍ، وكامل الإصبع على الزجاج. إذا استمر بنك ما بالحصول على درجات أقل بقليل من الحد مع بصمات حقيقية، راجع درجاته في التقارير ← جودة البصمة وفكّر في حد خاص بالبنك في صفحة العميل." },
    reply: { en: "The fingerprint image was not clear enough to verify. Please clean the sensor, place the finger flat and firmly in the centre, and capture it again.", ar: "لم تكن صورة البصمة واضحة بما يكفي للتحقق. يرجى تنظيف الماسح ووضع الإصبع بشكل مسطّح وثابت في المنتصف ثم إعادة الالتقاط." },
    escalate: { en: "No. Only if the quality service shows “Offline” on Settings → Fingerprint image — then tell dev.", ar: "لا. فقط إذا ظهرت خدمة الجودة «متوقفة» في الإعدادات ← صورة البصمة — عندها أبلغ المطوّر." },
  },
  {
    code: 1004, http: 400, enumName: "IMAGE_FORMAT_REJECTED", category: "request", severity: "guide", escalateLevel: "maybe",
    keywords: "1004 image format rejected png palette indexed rgb wsq compression ppi resolution size integration صيغة الصورة مرفوضة",
    name: { en: "Fingerprint image format rejected", ar: "رُفضت صيغة صورة البصمة" },
    meaning: { en: "The image the bank sent is not in an accepted format: not WSQ/PNG, a PNG that is not 8-bit greyscale (usually indexed/palette or RGB), wrong size or resolution, or an over-compressed WSQ. This is a defect in the bank's software, not the capture. The bank was not charged; the exact rule is under “Image check” on the transaction.", ar: "الصورة التي أرسلها البنك ليست بصيغة مقبولة: ليست WSQ/PNG، أو PNG ليست رمادية 8-بت (غالبًا مفهرسة/لوحة ألوان أو RGB)، أو حجم/دقة خاطئة، أو WSQ مضغوطة أكثر من اللازم. هذا خلل في برنامج البنك وليس في الالتقاط. لم يُخصم من البنك؛ والقاعدة الدقيقة تحت «فحص الصورة» في المعاملة." },
    action: { en: "Recapturing will not fix it. Send the bank's integration team the rule shown under “Image check” and point them to ICD §4.2.3 (export with the scanner SDK's WSQ or 8-bit greyscale PNG function, 500 ppi).", ar: "إعادة الالتقاط لن تحل المشكلة. أرسل لفريق تكامل البنك القاعدة الظاهرة تحت «فحص الصورة» ووجّههم إلى وثيقة الواجهة §4.2.3 (التصدير عبر دالة WSQ أو PNG الرمادية 8-بت في حزمة الماسح، بدقة 500 نقطة/بوصة)." },
    reply: { en: "The fingerprint image was sent in a format our service does not accept. Please forward this to your technical team: the image must be WSQ or 8-bit greyscale PNG at 500 ppi as described in the integration guide, section 4.2.3.", ar: "أُرسلت صورة البصمة بصيغة لا تقبلها خدمتنا. يرجى إحالة هذا إلى فريقكم التقني: يجب أن تكون الصورة WSQ أو PNG رمادية 8-بت بدقة 500 نقطة/بوصة كما هو موضح في دليل التكامل، القسم 4.2.3." },
    escalate: { en: "Maybe — if the bank insists their export is correct, send dev the requestId so we can check the image details.", ar: "ربما — إذا أصرّ البنك على أن تصديرهم صحيح، أرسل للمطوّر رقم الطلب (requestId) لنفحص تفاصيل الصورة." },
  },
  {
